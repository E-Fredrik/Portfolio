  ...
  return (
    ...
    >
      ...
      >
        ...
        {/*  INTRO PANEL                                                 */}
        {/* ============================================================ */}
        <div className="w-screen h-full flex items-end px-8 lg:px-16 pb-24 shrink-0">
        ...
        {/*  01 — NAVI                                                   */}
        {/* ============================================================ */}
        <div className="w-screen h-full flex items-center shrink-0 px-8 lg:px-16">
          <div className="w-full grid grid-cols-1 lg:grid-cols-[400px_1fr] gap-0 max-w-[1200px]">
...
└─ views/
   ...
   └─ CheckIn.tsx`}
        ...
        {/* ============================================================ */}
        <div className="w-screen h-full flex items-center shrink-0 px-8 lg:px-16">
          <div className="w-full grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-0 max-w-[1200px]">
            <div className="flex items-center justify-center p-8 lg:p-12">
